...
\skv
\it\centerline{Due Sat, April 2nd by 11:59pm in filedrop}\rm
\skv
...
\skv
{\bf 1.} Problem 3.7 (we discussed (c) in class, but did not quite finish)
...
{\bf 4.} Problem 7.2.
\skv
{\bf 5.} Problem 7.3. Make sure to prove your answer.
\skv
{\bf 6.} Let $A$ be an alphabet and $n\in\dbN$. Recall that a code $C\subseteq A^n$ is {\bf shift-invariant} if 
