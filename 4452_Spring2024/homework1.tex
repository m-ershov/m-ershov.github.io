...
\bf\centerline{Homework \#1. Due Saturday, January 27th, by 11:59pm}\rm
\vskip .1cm
...
\skv
\skv
2. Plan for next week: Tue, Jan 23 -- Chapter 2; Thu, Jan 25 -- 3.1 and 4.1.
\skv
...
\skv
{\bf 1.} The parity-check code of length $n$, denoted below by $PCC_n$, is defined by
...
\item[(b)*] As we will observe in Lecture~2, $|PCC_n|=2^{n-1}$. Prove that $PCC_n$ is the largest possible $1$-error detecting binary code of length $n$, that is,
